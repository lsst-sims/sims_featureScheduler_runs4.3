...
from new_fp import UpdateFootPrint
...
def gen_scheduler(args):
    ...
    fileroot, extra_info = set_run_info(dbroot=dbroot, file_end="ne%i_v4.3.2_" % nexp, out_dir=out_dir)
    ...
    sky = UpdateFootPrint(nside=nside)
